...
#endif
{
    ...
    public abstract class ItemSetBase : IDataStoreItemSet
    {
        ...
        public ItemSetBase(IDataStoreType list, Query query)
        {
            this.list = list;
            this.query = query;
        }
        ...
        public abstract void Retrieve(AsyncCallback callback, object state);
